...
public class Login extends Activity {
    ...
    protected void onCreate(Bundle savedInstancedState) {
        ...
        //객체참조 및 초기화
        ID_Edit = (EditText)findViewById(R.id.ID_Edit); ID_Edit.setText(null);
        PW_Edit = (EditText)findViewById(R.id.PW_Edit); PW_Edit.setText(null);
    ...
    void login(){
        try{
            ...
            httppost= new HttpPost("http://gudwns999.com/PHP/checkID.php"); // make sure the url is correct. Test
            //add your data
